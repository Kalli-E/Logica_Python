...
if len(passaros) >0:
    ...
    rodando = False
        ...
        for i, passaro in enumarate(passaros):
...
def main(genomas, config):
    ...
    global geracao # Para modificar a variável global. Equivale ao ´public static´ de outras linguagens
    geracao+=1
